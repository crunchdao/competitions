...
def run(
    ...
    if context.is_local:
        ...
        perturbations_to_score_file_path = os.path.join(data_directory_path, "score_perturbations_2.txt")
        ...
        genes_to_score_file_path = os.path.join(data_directory_path, "score_genes_2.txt")
